...
class ResPartner(models.Model):
    ...
    def _is_residential_address(self):
        """Determine if the address is residential based on partner type and relationship"""
        ...
        # Case 3: If the recipient has a parent contact and if the parent contact is residential
        if self.parent_id:
