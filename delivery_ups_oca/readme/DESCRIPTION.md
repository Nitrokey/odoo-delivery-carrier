...
so no need of exchanging any kind of file. It also provides paperless
documents functionality for international shipments, automatically
sending the required documentation to UPS.
