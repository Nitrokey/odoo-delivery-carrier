...
any kind of file. The module also supports insurance for your shipments, allowing you
to specify a percentage of the shipment value to be insured. Additionally, it provides
paperless invoice functionality for international shipments, automatically sending
required documentation to UPS.
